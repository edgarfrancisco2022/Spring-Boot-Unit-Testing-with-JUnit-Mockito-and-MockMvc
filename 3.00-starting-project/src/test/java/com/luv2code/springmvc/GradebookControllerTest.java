...
public class GradebookControllerTest {
    ...
    public static void setup() {
        request = new MockHttpServletRequest(); // object to create http requests
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        CollegeStudent studentTwo = new GradebookCollegeStudent("Edgar", "Perez",
                "edgar_perez@luv2code_school.com");
