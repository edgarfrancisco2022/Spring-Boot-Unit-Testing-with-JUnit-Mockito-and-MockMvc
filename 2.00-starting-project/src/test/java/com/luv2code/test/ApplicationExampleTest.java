...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        System.out.println("Testing: " + appInfo + " which is " + appDescription +
                " Version: " + appVersion + ". Execution of test method " + 1);
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setFirstname("Edgar");
        studentTwo.setLastname("Perez");
        studentTwo.setEmailAddress("edgar@test.com");
    ...
    public void findGradePointAverage() {
        assertAll("Testing all asertEquals",
                () -> assertEquals(353.25, studentGrades.addGradeResultsForSingleClass(
                        student.getStudentGrades().getMathGradeResults())),
