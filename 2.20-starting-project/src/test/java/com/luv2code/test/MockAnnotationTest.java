...
public class MockAnnotationTest {
    ...
    public void beforeEach() {
        ...
        studentOne.setEmailAddress("eric@email.com");
    ...
    public void testAssertNotNull() {
        ...
        assertNotNull(String.valueOf(applicationService.checkNull(studentOne.getStudentGrades().getMathGradeResults())), "Object should not be null");
    }
